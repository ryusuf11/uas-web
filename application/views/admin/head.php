<div class="navbar navbar-default navbar-fixed-top header-highlight">
  <div class="navbar-header">
    <a class="navbar-brand" href="<?php echo base_url(); ?>"><b style="color:white;font-size:17px;"><i>KEPENDUDUKAN </i></b></a>
    ...
    <ul class="nav navbar-nav navbar-right">
      <li class="dropdown dropdown-user">
        <a class="dropdown-toggle" data-toggle="dropdown">
          ...
          <span><?php echo getnama($this->session->userdata('id_penduduk')); ?></span> <?php if($this->session->userdata('level')==1){echo "Superadmin";}else{echo "Admin";} ?>
          <i class="caret"></i>
        </a>
